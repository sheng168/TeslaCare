...
final class CloudKitPublicService {
    ...
    @MainActor
    func publishCar(_ car: Car, listingType: ListingType, listingURL: URL?, askingPrice: Double?, hasFSD: Bool, freeSupercharging: Bool) async throws {
    ...
    private func applyFields(of car: Car, listingType: ListingType, listingURL: URL?, askingPrice: Double?, hasFSD: Bool, freeSupercharging: Bool, to record: CKRecord) {
        ...
        if let price = askingPrice { record["askingPrice"] = NSNumber(value: price) }
